...
class Install
{
    ...
    {
        echo 'Gaia-Goods installation successful, please execute `php gaia vendor:publish gaia\goods`' . PHP_EOL;
    }
    ...
    {
        echo 'Gaia-Goods upgrade successful, please execute `php gaia vendor:publish gaia\goods`' . PHP_EOL;
    }
